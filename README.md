...
My five steps data transformation are as following:
    ...
    Step two is to extract only the measurements on the mean and standard deviation for each measurement of my data
